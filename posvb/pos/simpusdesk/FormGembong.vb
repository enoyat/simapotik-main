...
Public Class FormGembong
    ...
    Sub CariBarang(kode)
        ...
        Dim xharga, jumlah, xqty, qty, total As Int32
        ...
        If (isdata.Count > 0) Then
            ...
            End If
            If (cbjenisharga.SelectedIndex = 1) Then
                xharga = jsonObject.SelectToken("data")("hna")
            Else
                xharga = jsonObject.SelectToken("data")("hna")
            End If
            If xnamabarang <> "" Then
    ...
    Private Sub txtkdbarang_KeyDown(sender As Object, e As KeyEventArgs) Handles txtkdbarang.KeyDown
        ...
        ElseIf (e.KeyCode = Keys.F2) Then
            FormBarangGembong.Close()
            FormBarangGembong.ShowDialog()
        End If
    End Sub
    ...
    Private Sub PD_PrintPage(sender As Object, e As PrintPageEventArgs) Handles PD.PrintPage
        ...
        e.Graphics.DrawString("Bayar : ", f10b, Brushes.Black, 120, 20 + tinggi)
        e.Graphics.DrawString(Format(bayar, "##,##0"), f10b, Brushes.Black, rigtmargin, 20 + tinggi, kanan)
        e.Graphics.DrawString("Kembalian : ", f10b, Brushes.Black, 120, 30 + tinggi)
        e.Graphics.DrawString(txtkembali.Text, f10b, Brushes.Black, rigtmargin, 30 + tinggi, kanan)

        e.Graphics.DrawString("Mohon periksa kembalian dan barang yang telah", f10, Brushes.Black, 0, 50 + tinggi)
        e.Graphics.DrawString("dibeli tidak bisa dikembalikan", f10, Brushes.Black, 0, 60 + tinggi)
        e.Graphics.DrawString("SEMOGA LEKAS SEMBUH", f10, Brushes.Black, 0, 70 + tinggi)
        e.Graphics.DrawString("~ 0 ~", f10, Brushes.Black, centermargin, 90 + tinggi)
    End Sub
