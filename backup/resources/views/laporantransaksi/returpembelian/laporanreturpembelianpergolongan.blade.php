...
<table width="900" border="0" cellpadding="0" cellspacing="0" style="font-size: 11px">
    <tr>
    <td align="center" colspan="3"><h2>LAPORAN RETUR PEMBELIAN</h2></strong></p>		</td>
    </tr>
      <tr>
    ...
    foreach ($datapembelian as $data) {
        $rungolongan=$data->namagolongan;
                    if ($stategolongan!=$rungolongan) {
                        ...
                        $diskon=$data->diskonpersen/100*$data->harga*$data->qty;
                        $jumlah=$data->harga*$data->qty-$diskon;
        ...
        echo "<td align=right>".number_format($diskon)."</td>";
