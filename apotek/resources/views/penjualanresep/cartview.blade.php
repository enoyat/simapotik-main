                ...
                <div class="col-lg-4 col-md-7 col-12">
                    <div class="right">
                        <ul>
                            ...
                            <li>
                                <label>Pembayaran</label><span>
                                    <input type="text" id="pembayaran" name="pembayaran" value="0" style="text-align: right"
                                        class="">
                                </span>
                            </li>

                            <li><label>Kembali</label><span><input type="text" id="kembali"
...
$("#pembayaran").keyup(function() {
    ...
    $("#kembali").val(Number(kembali).toLocaleString("en-US"));
