Public Class FormCustomer
    Sub cari()
        ...
        parameters.Add("namacustomer", txtcari.Text)
        ...
        If state = "success" Then
            ...
            datacustomer.Columns.Add("idcustomer", GetType(String))
            datacustomer.Columns.Add("namacustomer", GetType(String))
            datacustomer.Columns.Add("kategori", GetType(String))
            For Each Row2 In respons("data")
                datacustomer.Rows.Add(Row2("idcustomer").ToString(),
                          Row2("namacustomer").ToString(),
                          Row2("kategori").ToString()
                          )
            Next
            DataGridView1.DataSource = datacustomer
    ...
    Private Sub DataGridView1_KeyDown(sender As Object, e As KeyEventArgs) Handles DataGridView1.KeyDown
        ...
        If (e.KeyCode = Keys.Enter) Then
            ...
            If (caller.Text = "penjualanresep") Then
                ...
                Close()
            End If
            If (caller.Text = "kelontong") Then
                FormKelontong.txtkdcustomer.Text = Convert.ToString(DataGridView1.Item(0, DataGridView1.CurrentRow.Index).Value)
                FormKelontong.txtnamacustomer.Text = Convert.ToString(DataGridView1.Item(1, DataGridView1.CurrentRow.Index).Value)
                FormKelontong.kategori.Text = Convert.ToString(DataGridView1.Item(2, DataGridView1.CurrentRow.Index).Value)
                FormKelontong.ubahharga()
                Close()
            End If
