...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>LAPORAN TRANSAKSI PENYESUAIAN</h1>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    @endif
                    <form action="{{ route('laptransaksipenyesuaian') }}" method="POST" target="_blank">
                        @csrf

                        <table class="table table-responsive">
                            <tr>
                                <td colspan="2" style="background: blue; color: white">LAPORAN TRANSAKSI PENYESUAIAN
                                </td>
                            </tr>
                            <tr>
