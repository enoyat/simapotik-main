    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Pembatalan Jurnal Penyesuaian</h1>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <a class="btn btn-info" href="{{ route('trjurnalpenyesuaian.batal') }}">
                                                Refresh</a>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <script type="text/javascript">
                            $('#btncari').click(function() {
                                ...
                                var id = $("#notrans").val();
                                $.ajax({
                                    url: "{{ route('trjurnalpenyesuaian.carijurnal') }}",
                                    data: {
                                        id: id
                                    },
                                    dataType: 'json',
                                    success: function(data) {
                                        ...
                                        if (data.length < 1) {
                                            ...
                                            for (i = 0; i < data.length; i++) {
                                                ...
                                                html += "<li class='list-group-item'> <b>No.Transaksi: </b>" + data[i]
                                                    .notrans + " | <b>Keterangan:</b> " + data[i].keterangan + "</li>";
                                            }
                                            $('#datajurnal').html(html + '</ul>');
                                            $.get("/trjurnalpenyesuaian/detail/" + notrans, function(data) {
                                                $("#formbatal").html(data);
                                            });
                                        }
                                    }
