                        ...
                        <div id="area-print">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>customer</td>
                                    <td>:</td>
                                    <td>{{ $retur->get_penjualan->get_customer->namacustomer }}</td>
                                </tr>
                                <tr>
                            ...
                            <table class="table table-bordered mb-5" style="text-align: left; font-size: 10px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%">{{ $data->get_detailpenjualan->harga }}</td>
                                        <td width="5%" style="text-align: center;">{{ $data->qty }}</td>
                                        <td width="5%" style="text-align: center;">{{ number_format($data->qty*$data->get_detailpenjualan->harga) }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
