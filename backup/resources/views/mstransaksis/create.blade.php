...
<div class="content-wrapper">
    ...
    <div class="container">
        ...
        <div class="row mt-5 mb-5">
            <div class="col-lg-12 margin-tb">
                <div class="float-left">
                    <h2>Create Ayat Jurnal Transaksi</h2>
                </div>
        ...
        <form action="{{ route('mstransaksis.store') }}" method="POST">
            @csrf
            @method('POST')
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="namatransaksi" value="" class="form-control" placeholder="Title">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
