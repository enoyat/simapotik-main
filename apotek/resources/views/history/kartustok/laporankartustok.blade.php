...
<table width="700" height="21" border="1" cellspacing="0" bordercolor="#000000" class="grid"
    ...
    <td align="center"> <a href="{{ URL::to('hskartustok/detail?kdtransaksi=pembelian&kdbarang=' . $data->kdbarang) }}"
            target="_blank">{{ $data->jmlpembelian }}</a></td>
    <td align="center"> <a
            href="{{ URL::to('hskartustok/detail?kdtransaksi=returpembelian&kdbarang=' . $data->kdbarang) }}"
            target="_blank">{{ $data->jmlreturpembelian }}</a></td>
    <td align="center"> <a href="{{ URL::to('hskartustok/detail?kdtransaksi=penjualan&kdbarang=' . $data->kdbarang) }}"
            target="_blank">{{ $data->jmlpenjualan }}</a></td>
    <td align="center"> <a
            href="{{ URL::to('hskartustok/detail?kdtransaksi=returpenjualan&kdbarang=' . $data->kdbarang) }}"
            target="_blank">{{ $data->jmlreturpenjualan }}</a></td>
    <td align="center"> <a
            href="{{ URL::to('hskartustok/detail?kdtransaksi=adjustmutasi&kdbarang=' . $data->kdbarang) }}"
