Public Class FormBarangResep
    Sub cari()
        Dim parameters = New Specialized.NameValueCollection
        Dim lokasi = FormPenjualanResep.ComboLokasi.SelectedIndex
    ...
    Private Sub DataGridView1_KeyDown(sender As Object, e As KeyEventArgs) Handles DataGridView1.KeyDown
        If (e.KeyCode = Keys.Enter) Then
            FormPenjualanResep.txtkdbarang.Text = Convert.ToString(DataGridView1.Item(0, DataGridView1.CurrentRow.Index).Value)
            Close()
