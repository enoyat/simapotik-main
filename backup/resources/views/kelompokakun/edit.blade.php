         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="kdtransaksi" value="{{ $subtransaksis->kdtransaksi }}" class="form-control" readonly="">
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="kdsubtransaksi" value="{{ $subtransaksis->kdsubtransaksi }}" class="form-control" placeholder="Title">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Nama Transaksi:</strong>
                    <input type="text" name="namasubtransaksi" value="{{ $subtransaksis->namasubtransaksi }}" class="form-control" placeholder="Title">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Akun Debet:</strong>
                     <select name="kdakun_d" id="kdakun_d" class="form-control">
                                    <option value="{{ $subtransaksis->kdakun_d }}">{{ $subtransaksis->get_akundebet->namaakun }}</option>
                ...
                <div class="form-group">
                    <strong>Akun Kredit:</strong>
                     <select name="kdakun_k" id="kdakun_k" class="form-control">
                                    <option value="{{ $subtransaksis->kdakun_k }}">{{ $subtransaksis->get_akunkredit->namaakun }}</option>
