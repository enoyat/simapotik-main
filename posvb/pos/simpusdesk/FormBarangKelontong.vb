Public Class FormBarangKelontong
    Sub cari()
        ...
        Dim respons = postData(urlprefix + "barang/getbarangkelontong", "POST", parameters)
    ...
    Private Sub DataGridView1_KeyDown(sender As Object, e As KeyEventArgs) Handles DataGridView1.KeyDown
        If (e.KeyCode = Keys.Enter) Then
            FormKelontong.txtkdbarang.Text = Convert.ToString(DataGridView1.Item(0, DataGridView1.CurrentRow.Index).Value)
            Close()
