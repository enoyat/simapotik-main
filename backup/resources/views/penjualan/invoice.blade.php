                        ...
                        <div id="area-print">
                            ...
                            <table width="500px">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>{{ date_format(date_create($datapenjualan->tgltrans),"d-m-Y") }}, Jam {{ $datapenjualan->jam }}</td>
                                </tr>
                                <tr>
                            ...
                            <table border="1" style="text-align: left; font-size: 12px"  width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" style="text-align: right">Total: {{ number_format($datapenjualan->total,0) }}</td>
