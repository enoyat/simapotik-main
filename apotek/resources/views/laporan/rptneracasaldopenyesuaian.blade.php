...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>LAPORAN NERACA SALDO SETELAH PENYESUAIANS</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="container" style="text-align: center">
                        ...
                        @endif
                        <form action="{{ route('neracasaldopenyesuaian') }}" method="POST" target="_blank">
                            @csrf

                            <table class="table table-responsive">
                                <tr>
                                    <td colspan="2" style="background: blue; color: white">LAPORAN NERACA SALDO SETELAH
                                        PENYESUAIAN</td>
                                </tr>
                                <tr>
