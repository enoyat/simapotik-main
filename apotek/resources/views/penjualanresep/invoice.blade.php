                ...
                <div class="col-12">
                    ...
                    <div class="container">
                        ...
                        <div id="area-print">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>Pasien</td>
                                    <td>:</td>
                                    <td>{{ $dataresep->namapasien }}</td>
                                </tr>
                                <tr>
                                    <td>Tanggal Transaksi</td>
                                    <td>:</td>
                                    <td>{{ date_format(date_create($datapenjualan->tgltrans),"d-m-Y") }}</td>
                                </tr>
                                <tr>
                                    <td>Jenis Pasien</td>
                                    <td>:</td>
                                    <td>{{ $dataresep->get_jenispasien->namajenispasien }}</td>
                                </tr>
                                <tr>
                                    <td>Poly</td>
                                    <td>:</td>
                                    <td>{{ $dataresep->get_poly->namapoly }}</td>
                                </tr>
                                <tr>
                                    <td>Dokter</td>
                                    <td>:</td>
                                    <td>{{ $dataresep->get_dokter->namadokter }}</td>
                                </tr>
                                <tr>
                                    <td>No Resep</td>
                                    <td>:</td>
                                    <td>{{ $dataresep->noresep }}</td>
                                </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5"> Terbilang:
                                            ...
                                            <label>
                                                @php
                                                $terbilang =Penjualanresep::terbilang($datapenjualan->total,$style=3);
                                                @endphp
                                                {{ $terbilang }} Rupiah
                                            </label>
                                        </td>
                                        <td  style="text-align: right">Total: {{ number_format($datapenjualan->total,0) }}</td>
                        ...
                        <button type="button" class="btn btn-primary" id="cetak" onclick="printDiv('area-print')">Cetak
                            Bukti</button>
                            <a class="btn btn-primary" href="{{ route('penjualanresep.baru') }}">Selesai</a>
                    </div>
                </div>
            </div>
        </div>
