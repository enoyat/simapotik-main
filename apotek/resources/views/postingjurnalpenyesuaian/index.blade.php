                ...
                <div class="row">
                    <div class="col-12">
                        <div class="container" style="text-align: center">
                            ...
                            @endif
                            <form action="{{ route('postingjurnalpenyesuaian.posting') }}" method="POST">
                                @csrf

                                <table class="table table-hover">
                                    <tr>
                                        <td colspan="2" style="background: blue; color: white">POSTING JURNAL PENYESUAIAN
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Tahun </td>
                                        <td><input type="text" name="tahun" value="<?php echo gmdate('Y', time() + 60 * 60 * 7); ?>" size=5
