            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">IN RETUR</h5>
                    ...
                    @if ($message = Session::get('success'))
                        ...
                        <div class="container">
                            ...
                            <div id="area-print">
                                ...
                                <form action="{{ route('pembelian.approveinretur') }}" method="POST">
                                    @csrf
                                    ...
                                    <table>
                                        <tr>
                                            <td>No. Retur</td>
                                            <td>:</td>
                                            <td>{{ $pembelian->idretur }}
                                                <input type="hidden" value="{{ $pembelian->idretur }}" name="idretur"
                                                    id="idretur" >
                                                    <input type="hidden" value="{{ $pembelian->iddetailpembelian }}" name="iddetailpembelian"
                                                    id="iddetailpembelian" >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="10%" style="text-align: left;">
                                                            ...
                                                            <a class="btn btn-sm btn-info  btn-action"
                                                                data-url="{{ route('pembelian.forminretur',['kdbarang'=>$data->kdbarang,'idrecord'=>$i]) }}"
