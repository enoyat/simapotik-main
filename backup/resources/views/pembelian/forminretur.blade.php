<div class="container">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" id="idlokasi" name="idlokasi" value="{{ $barang->idlokasi }}" readonly>
        </div>
    </div>
    <div class="form-group row">
        <label for="stok" class="col-sm-3 col-form-label">Qty Retur</label>
        <div class="col-sm-8">
    ...
    <div class="form-group row">
        <label for="stok" class="col-sm-3 col-form-label">Qty Telah Kembali</label>
        <div class="col-sm-8">
            <input type="text" class="form-control" id="qtykembali" name="qtykembali" value="{{ $barang->qtykembali }}"
                readonly>
        </div>
    </div>
    <div class="form-group row">
        <label for="stok" class="col-sm-3 col-form-label">Qty Sisa</label>
        <div class="col-sm-8">
            <input type="text" class="form-control" id="stok" name="stok" value="{{ $barang->qty-$barang->qtykembali }}"
                readonly>
        </div>
    </div>
    <div class="form-group row">
        <label for="qtybeli" class="col-sm-3 col-form-label">In Retur</label>
        <div class="col-sm-8">
